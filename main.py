...
if __name__ == "__main__":
	...
	argparser.add_argument(
		'--host',
		metavar='H',
		#default='167.205.66.12',
		#help='IP of the host CARLA Simulator (default: 167.205.66.12)')
		default='localhost',
	...
	try:
		...
		try:
			...
			sensor = world.spawn_actor(cam_bp, spawn_point, attach_to=vehicle_lidar)
			sensor.listen(lambda data : lib_lidar.process_img(data, i_image))
			"""
			...
			while True:
				...
				#PRINT CARLA MEASUREMENT:
				lib_lidar.print_vehicle(world, vehicle_lidar)
