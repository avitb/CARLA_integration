...
def process_img(image, i_image_fungsi):
    ...
    string_image_save_to_disk = "G:/Akademik/Semester ekstensi/TA2021/SERVER/Integrasi Carla/NEW w kak khansa/Simulasi LIDAR/Bentuk library (CARLA)/v3"+str(i_image_fungsi)#"C:/carla9.12/result/"+str( i_image_fungsi )
